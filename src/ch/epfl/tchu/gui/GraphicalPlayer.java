...
public final class GraphicalPlayer {
    ...
    public GraphicalPlayer(PlayerId ownId,
        ...
        parameters.getItems().add(item);

        menuBar.getMenus().add(parameters);

        BorderPane windowView = new BorderPane(mapView, null, cardsView, handView, infoView);
...
//                drawCard(drawCardHandler);
    ...
    private Stage createParamWindow(){
        ...
        stop.setGraphic(new ImageView(new Image("/stop.png")));
